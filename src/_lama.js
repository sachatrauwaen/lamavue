...
(function ($) {
    var Lama = function () {
        ...
        if (args.length === 0) {
            // illegal
            return Lama.throwDefaultError("You must supply at least one argument.  This argument can either be a DOM element against which Lama will generate a form or it can be a function name.");
        }
            ...
            */
            ...
            copyOf: function (thing) {
                ...
                if (Lama.isArray(thing)) {
                    ...
                    else if (Lama.isPlainObject(thing)) {
                        copy = {};
            ...
            isValEmpty: function (val, includeFunctions) {
                ...
                if (Lama.isEmpty(val, includeFunctions)) {
                    ...
                    if (Lama.isObject(val) && Lama.isEmptyObject(val)) {
                        empty = true;
                    }
